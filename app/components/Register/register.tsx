            ...
            <div className="flex flex-col items-center justify-center w-2/5 h-5/6 ">
                <div className="bg-white rounded-3xl p-5">
                   <h1 className="text-4xl text-center">Criar uma nova conta</h1>
                       <form>
                            <div className="flex gap-x-10 m-3 my-10">
                                <div className="flex gap-x-2 items-center">
                                    <label htmlFor="inome">Nome:</label>
                                    <input className="border-solid border-2 border-black-100 rounded h-10" type="text" name="nome" id="inome" autoComplete="given-name" required/>
                                </div>
                                <div className="flex gap-x-2 items-center">
                                    <label htmlFor="isobrenome">Sobrenome:</label>
                                    <input className="border-solid border-2 border-black-100 rounded h-10" type="text" name="sobrenome" id="isobrenome" autoComplete="family-name" required />
                                </div>
                            </div>
                            <div className="flex gap-x-2 m-3 my-10 items-center">
                                <label htmlFor="iemail">E-mail:</label>
                                <input className="border-solid border-2 border-black-100 rounded h-10" type="email" name="email" id="iemail" autoComplete="off" required />
                            </div>
                            <div className="flex gap-x-2 m-3 my-10 items-center">
                                <label htmlFor="isenha">Senha:</label>
                                <input className="border-solid border-2 border-black-100 rounded h-10" type="password" name="senha" id="isenha" minLength={8} required />
                            </div>
